...
class StatisticsControllerTest < ActionController::TestCase
  ...
  test "should create statistic" do
    assert_difference('Statistic.count') do
      post :create, statistic: { action: @statistic.action, count: @statistic.count, object_id: @statistic.object_id, object_type: @statistic.object_type, user_id: @statistic.user_id }
    end
  ...
  test "should update statistic" do
    patch :update, id: @statistic, statistic: { action: @statistic.action, count: @statistic.count, object_id: @statistic.object_id, object_type: @statistic.object_type, user_id: @statistic.user_id }
    assert_redirected_to statistic_path(assigns(:statistic))
  end
